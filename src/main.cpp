...
// Pump 1
int watering1[3] = {18, 5, 0}; // when to foce water (hh:mm:ss)
int watering_pumptime1[3] = {0, 0, 30}; // for how long water (hh:mm:ss)

// Pump 2
int watering2[3] = {21, 10, 5}; // when to foce water (hh:mm:ss)
int watering_pumptime2[3] = {0, 0, 15}; // for how long water (hh:mm:ss)
